...
IPAddress ip(192,168,69,177); // IP estatico caso o DHCP falhe,
EthernetClient client; // inicializa a biblioteca

IPAddress server(200,219,135,63); //Endereco de IP do Servidor
